...
function get_game_by_id($game_id) {
    global $connection;
    $query = "SELECT jeu.id, jeu.titre, jeu.description, jeu.image_path as game_image, jeu.date_sortie, restriction_age.image_path as age_image, restriction_age.label as min_age, console.label as console_name, note.note_media, note.note_utilisateur FROM jeu 
